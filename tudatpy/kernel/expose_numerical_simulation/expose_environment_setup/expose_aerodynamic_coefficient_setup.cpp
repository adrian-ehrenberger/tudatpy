...
namespace aerodynamic_coefficients {
    ...
    void expose_aerodynamic_coefficient_setup(py::module &m) {
        ...
        // py::class_<tss::RarefiedFlowAerodynamicCoefficientSettings,
        //         std::shared_ptr<tss::RarefiedFlowAerodynamicCoefficientSettings>>(
        //         m, "RarefiedFlowAerodynamicCoefficientSettings");

        m.def("rarefied_flow",
            &tss::rarefiedFlowAerodynamicCoefficientSettings,
            py::arg("reference_length"),
            py::arg("reference_area"),
            py::arg("moment_reference_point") = Eigen::Vector3d::Constant( TUDAT_NAN ),
            py::arg("independent_variable_names") = std::vector<ta::AerodynamicCoefficientsIndependentVariables>{
        ...
        // std::vector<ta::AerodynamicCoefficientsIndependentVariables> independent_variable_names = {
        //     ta::AerodynamicCoefficientsIndependentVariables::angle_of_attack_dependent,
        //     ta::AerodynamicCoefficientsIndependentVariables::angle_of_sideslip_dependent,
        ...
        //     &tss::hypersonicFlowAerodynamicCoefficientSettings,
        //     py::arg("reference_length"),
        //     py::arg("reference_area"),
        //     py::arg("moment_reference_point") = Eigen::Vector3d::Constant( TUDAT_NAN ),
        ...
        //     &tss::bridgedModelsAerodynamicCoefficientSettings,
